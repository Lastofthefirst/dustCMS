...
describe('Auth API', () => {
  ...
  describe('POST /api/setup', () => {
    test('should create super admin', async () => {
      const response = await makeRequest(app, 'POST', '/api/setup', {
        body: {
          email: 'admin@test.com',
          password: 'testpass123',
    ...
    test('should reject setup when already completed', async () => {
      await createTestSuperAdmin();
    ...
    test('should reject setup without email', async () => {
      const response = await makeRequest(app, 'POST', '/api/setup', {
        body: {
          password: 'testpass123',
        },
    ...
    test('should reject setup without password', async () => {
      const response = await makeRequest(app, 'POST', '/api/setup', {
        body: {
          email: 'admin@test.com',
        },
